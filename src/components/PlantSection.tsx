...
//         {/* LEFT CARD */}
//         <div className="flex items-center justify-between bg-[#F5F5F5] p-6 rounded-xl relative overflow-hidden">
//           <img
//             src={GU}
//             alt="Summer cactus"
//             className="w-[120px] sm:w-[160px] md:w-[180px] object-contain"
//           />
...
//             <button className="bg-main text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-green-700 transition">
//               Find More →
//             </button>
//           </div>
//         </div>
